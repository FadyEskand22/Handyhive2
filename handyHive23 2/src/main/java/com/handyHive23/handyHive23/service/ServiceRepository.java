...
public interface ServiceRepository extends JpaRepository<ServicePost, Long> {
    ...
    List<ServicePost> findByProviderExpertiseContainingIgnoreCase(String expertise);

    List<ServicePost> findByTitleContainingIgnoreCaseOrDescriptionContainingIgnoreCase(String expertise,
            String expertise2);
